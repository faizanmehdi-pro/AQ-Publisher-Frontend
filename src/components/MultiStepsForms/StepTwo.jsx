        ...
        <RadioGroup>
          ...
          <RadioOption>
            <RadioInput
              type="radio"
              name="process"
              value="Convert to Searchable"
              checked={formData.process === 'Convert to Searchable'}
              onChange={handleChange}
            />
          ...
          <RadioOption>
            <RadioInput
              ...
              checked={formData.process === 'Remove Duplicates'}
              onChange={handleChange}
            />
            Remove Duplicates
          </RadioOption>
