...
const DeleteDuplicateFile = ({ onBack }) => {
            ...
            {file ? (
                <PDFViewerWrapper>
                    ...
                    <BackIcon onClick={() => setFile(null)}><KeyboardBackspaceIcon /></BackIcon>
                        ...
                        <Button onClick={extractTextFromPage}>Delete Duplicate Files</Button>
                    </Nav>
                ...
                <FileInputButton>
                    ...
                    <h2>Delete Duplicate Files</h2>
                    <p>This is the page for deleting duplicate files from your PDF files.</p>
...
export default DeleteDuplicateFile;
