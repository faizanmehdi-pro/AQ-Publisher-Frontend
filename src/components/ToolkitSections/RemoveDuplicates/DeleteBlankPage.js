            ...
            {file ? (
                <PDFViewerWrapper>
                    ...
                    <BackIcon onClick={() => setFile(null)}><KeyboardBackspaceIcon /></BackIcon>
                        ...
                        <Button onClick={extractTextFromPage}>Delete Blank Pages</Button>
                    </Nav>
                ...
                <FileInputButton>
                    ...
                    <h2>Delete Blank Pages</h2>
                    <p>This is the page for deleting blank pages from your PDF files.</p>
...
export default DeleteBlankPage;
