...
const DeleteDuplicatePage = ({ onBack }) => {
            ...
            {file ? (
                <PDFViewerWrapper>
                    ...
                    <BackIcon onClick={() => setFile(null)}><KeyboardBackspaceIcon /></BackIcon>
                        ...
                        <Button onClick={extractTextFromPage}>Delete Duplicate Pages</Button>
                    </Nav>
                ...
                <FileInputButton>
                    ...
                    <h2>Delete Duplicate Pages</h2>
                    <p>This is the page for deleting duplicate pages from your PDF files.</p>
...
export default DeleteDuplicatePage;
