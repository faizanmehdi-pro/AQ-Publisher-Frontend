  ...
  return (
    <Container>
      ...
      <Card onClick={() => handleCardClick('SecondPage')}>
        <Icon>🛠️</Icon> {/* Tool icon to represent fixing or correcting errors */}
        <Title>Error Correction</Title>
        <Description>Automatically detect and correct errors in your PDF documents.</Description>
      </Card>
    </Container>
  );
};

export default FOTools;
