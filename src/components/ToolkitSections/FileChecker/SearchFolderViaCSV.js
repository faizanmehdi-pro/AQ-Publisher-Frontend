...
const SearchFolderViaCSV = ({ onBack }) => {
            ...
            {file ? (
                <PDFViewerWrapper>
                    <BackIcon onClick={() => setFile(null)}><KeyboardBackspaceIcon /></BackIcon>
                        ...
                        <Button onClick={extractTextFromPage}>Search Folders Via CSV</Button>
                </PDFViewerWrapper>
            ) : (
                <FileInputButton>
                    <BackIcon onClick={onBack}><KeyboardBackspaceIcon /></BackIcon>
                    <h2>Search Folders Via CSV</h2>
                    <p>This is the page for finding folders via csv.</p>
...
export default SearchFolderViaCSV;
