    ...
    return (
        <>
          ...
          <BackIcon onClick={() => setFile(null)}><KeyboardBackspaceIcon /></BackIcon>
              ...
              <Button onClick={extractTextFromPage}>Search Files via CSV</Button>
      </PDFViewerWrapper>
            ) : (
                <FileInputButton>
                    <BackIcon onClick={onBack}><KeyboardBackspaceIcon /></BackIcon>
                    <h2>Search Files Via CSV</h2>
                    <p>This is the page for searching find files via csv.</p>
...
export default SearchFileViaCSV;
