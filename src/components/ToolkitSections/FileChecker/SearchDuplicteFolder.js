...
const SearchDuplicteFolder = ({ onBack }) => {
            ...
            {file ? (
                <PDFViewerWrapper>
                    ...
                    <BackIcon onClick={() => setFile(null)}><KeyboardBackspaceIcon /></BackIcon>
                        ...
                        <Button onClick={extractTextFromPage}>Delete Pages by Content</Button>
                    </Nav>
                ...
                <FileInputButton>
                    ...
                    <h2>Search Duplicte Folder</h2>
                    <p>This is the page for finding Duplicte Folder.</p>
...
export default SearchDuplicteFolder;
