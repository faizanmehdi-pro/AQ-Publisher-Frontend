  ...
  return (
    <Container>
      <Card onClick={() => handleCardClick('FirstPage')}>
        <Icon>🔤</Icon> {/* Alphabet icon for sorting by name */}
        <Title>Sort by Name</Title>
        <Description>Organize and sort your files alphabetically.</Description>
      </Card>
      
      <Card onClick={() => handleCardClick('SecondPage')}>
        <Icon>📅</Icon> {/* Calendar icon for grouping by year */}
        <Title>Group into Folders by Year</Title>
        <Description>Group your files into folders based on the year they were created.</Description>
      </Card>
      
      <Card onClick={() => handleCardClick('ThirdPage')}>
        <Icon>🗂️</Icon> {/* File folder icon for sorting by content */}
        <Title>Sort by Content</Title>
        <Description>Sort and categorize files based on their content.</Description>
      </Card>
    </Container>
  );
};
